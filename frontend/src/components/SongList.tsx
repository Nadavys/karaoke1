...
function SongItem({ item }: { item: Video }) {
    ...
    return (
        <li className="max-w-2xl mx-auto bg-gray-100 rounded-2xl border-2 border-gray-300 shadow-xl overflow-hidden hover:bg-gray-50 hover:border-blue-500 my-4 cursor-pointer transition duration-500 ease-in-out" onClick={() => handleClick(item)}>
            <div className="flex">
